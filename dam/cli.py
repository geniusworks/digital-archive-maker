...
def rip_video(
    ...
    episode_start: Optional[int] = typer.Option(None, "--episode-start", help="Manually set starting episode number (overrides automatic detection)."),
):
    ...
    if skip_disc:
        env["SKIP_DISC"] = "true"
    if episode_start:
        env["EPISODE_START"] = str(episode_start)
