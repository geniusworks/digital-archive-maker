...
IGNORE_EXTS = {
    "db", "doc", "ds_store", "esc", "gif", "jpg", "json", "m3u",
    "pdf", "plist", "png", "strings", "txt", "webloc"
}
...
def main():
    ...
    only_in_old, only_in_new = compare_sets_fast(
        old_items, new_items, cutoff=args.threshold / 100
    )
    if args.albums:
