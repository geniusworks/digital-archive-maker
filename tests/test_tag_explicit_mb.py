...
class TestExplicitTagging:
    ...
    def test_search_musicbrainz_no_results(self, mock_search):
        ...
        result = tag_explicit_mb.search_musicbrainz_release("Nonexistent Album", "Nonexistent Artist")
...
class TestExplicitTaggingIntegration:
    ...
    def test_full_workflow_mock(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch('tag_explicit_mb.musicbrainzngs.search_releases') as mock_search, \
                ...
                # Setup mocks
                mock_search.return_value = {
                    'release-list': [{'id': 'test-release-id'}]
                }
