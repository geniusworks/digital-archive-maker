...
class TestCleanPlaylists:
    ...
    def test_process_playlist_success(self, mock_validate, mock_header, 
                                      mock_lineendings, mock_normalize, temp_dir):
    ...
    @patch('clean_playlists.ensure_extm3u_header')
    @patch('clean_playlists.validate_tracks')
    def test_process_playlist_replace_mode(self, mock_validate, mock_header, 
                                          mock_lineendings, mock_normalize, temp_dir):
