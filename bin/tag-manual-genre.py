...
def process_file(flac_path: Path, genre: str, force: bool = False, dry_run: bool = False, verbose: bool = False) -> str:
...
def main():
    ...
    parser.add_argument('--list-genres', action='store_true', help='List all valid genres and exit')
